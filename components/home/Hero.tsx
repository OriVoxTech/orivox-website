...
export function Hero() {
  ...
  return <section className="hero" id="home" onPointerMove={moveMark}>
    ...
    <Container className="hero__inner">
      ...
      <div ref={visual}  aria-label="Orivox three-dimensional brand mark">
        <div className="hero__brand-frame" aria-hidden="true">
          <Image src="/Multiple Pic.png" alt="" width={1350} height={1080} sizes="34vw" />
          <span>Brand / Product / Technology</span>
        </div>
        <div className="hero__orb" />
        <Image src="/Orivox 3D.png" alt="Sculptural green Orivox brand mark" width={1254} height={1254} priority sizes="(max-width: 768px) 95vw, 56vw" style={{ animation: "float 5s ease-in-out infinite" }} />
        {/* <div className="hero__glass-note" aria-hidden="true"><span>FROM POSSIBILITY</span><strong>TO PRODUCT.</strong></div> */}
      </div>
